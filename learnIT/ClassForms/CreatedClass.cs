...
{
    public partial class CreatedClass : Form
    {
        int Id;
        int ClassId;
        ...
        public CreatedClass(int classId, int id)
        {
            InitializeComponent();
            Id = id;
            ClassId = classId;
            ...
            foreach(UserTask taskInfo in TaskInfos)
            {
                ...
                Console.WriteLine(taskInfo.task_filename);
            }
        ...
        {
            AdminTaskOverview form = new AdminTaskOverview(taskId, ClassId, Id);
            this.Hide();
            form.ShowDialog();
        }
        ...
        {
            CreateTask form = new CreateTask(ClassId, Id);
            this.Hide();
            form.ShowDialog();
        }
    }
